...
const StatsDetails = ({ stats }: { stats: any }) => {
    ...
    return (
        <View style={{
            flexDirection: "row", alignItems: "center", justifyContent: "space-between", backgroundColor: colors.cardBackground,
            padding: 20, marginHorizontal: 5, borderRadius: 8,
            boxShadow: '0 2px 4px #ffffff66', elevation: 10
        }}
        >
